...
Baseado nas descrições a seguir, desenvolva em html,css, php e javascript caso precise, o app web mobile first, não se esqueça que irei conectar minha database wamp mysql.
...
```sh
git clone https://github.com/GPT-Engineer-App/finance-tracker-web-app.git
